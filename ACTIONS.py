            ...
            for item in range (0, DB.DRAW.Y_get_map):
                if DB.DRAW.get_map_points[elem][item] == 7:
                    if DB.DRAW.get_map_points[elem][item+1] == 1 or DB.DRAW.get_map_points[elem][item+1] == 3 or DB.DRAW.get_map_points[elem][item+1] == 6:
                        ...
                        isit = True
                        pl_current, iteracted, trash, flag = ITER.ITERACTS.is_iteracted(DB.DRAW.get_map_points[elem][item], DB.DRAW.get_map_points[elem][item+1], elem, item, isit, 3)
                        if flag == False:
            ...
            for item in range (0, DB.DRAW.Y_get_map):
                if DB.DRAW.get_map_points[elem][item] == 7:
                    if DB.DRAW.get_map_points[elem][item-1] == 1 or DB.DRAW.get_map_points[elem][item-1] == 3 or DB.DRAW.get_map_points[elem][item-1] == 6:
                        ...
                        isit = True
                        pl_current, iteracted, trash, flag = ITER.ITERACTS.is_iteracted(DB.DRAW.get_map_points[elem][item], DB.DRAW.get_map_points[elem][item-1], elem, item, isit, 2)
                        if flag == False:
                            DB.DRAW.get_map_points[elem][item] = iteracted
                            DB.DRAW.get_map_points[elem][item-1] = 7
                ...
                if DB.DRAW.get_map_points[elem][item] == 7:
                    try:
                        ...
                        if DB.DRAW.get_map_points[elem+1][item] == 1 or DB.DRAW.get_map_points[elem+1][item] == 3 or DB.DRAW.get_map_points[elem+1][item] == 6:
                            ...
                            isit = True
                            pl_current, iteracted, trash, flag = ITER.ITERACTS.is_iteracted(DB.DRAW.get_map_points[elem][item], DB.DRAW.get_map_points[elem+1][item], elem, item, isit, 1)
                            if flag == False:
                                DB.DRAW.get_map_points[elem][item] = iteracted
                ...
                if DB.DRAW.get_map_points[elem][item] == 7:
                    if elem == 0:
                        ...
                        if DB.DRAW.get_map_points[elem-1][item] == 1 or DB.DRAW.get_map_points[elem-1][item] == 3 or DB.DRAW.get_map_points[elem-1][item] == 6:
                            ...
                            isit = True
                            pl_current, iteracted, trash, flag = ITER.ITERACTS.is_iteracted(DB.DRAW.get_map_points[elem][item], DB.DRAW.get_map_points[elem-1][item], elem, item, isit, 0)
                            if flag == False:
                                DB.DRAW.get_map_points[elem][item] = iteracted
                                DB.DRAW.get_map_points[elem-1][item] = 7
